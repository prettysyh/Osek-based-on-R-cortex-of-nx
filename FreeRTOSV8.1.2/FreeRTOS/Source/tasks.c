...
TCB_t * pxNewTCB;
	...
	pxNewTCB = prvAllocateTCBAndStack( usStackDepth, puxStackBuffer );//申请TCB结构体和任务栈空间
...
// TCB_t * pxNewTCB;
	...
	// pxNewTCB = prvAllocateTCBAndStack( tskIDLE_STACK_SIZE, NULL );
	// pxCurrentTCB = pxNewTCB;
	if(1||xReturn){
	xPortStartScheduler();
	}
...
static portTASK_FUNCTION( prvIdleTask, pvParameters )
{
	...
	if(1){
	// combined_uart_raw_print("before task for",16);
